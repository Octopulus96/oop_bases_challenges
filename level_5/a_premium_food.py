...
if __name__ == '__main__':
    food_product_cheap = FoodProduct('Avocado', 5)
    print(food_product_cheap.get_product_info())

    food_product_expensive = FoodProduct('Lamb', 15)
    print(food_product_expensive.get_product_info())
